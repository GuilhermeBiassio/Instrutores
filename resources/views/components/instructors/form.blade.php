...
<form class="p-3" method="post" action="{{ $action }}">
    ...
    <div class="mb-3 input-group-lg">
        ...
        @if($errors->any())
            value="{{ old('final_percurso') }}"
        @endif
        >
    </div>
    <div class="form-floating mb-2">
        <textarea class="form-control" placeholder="Observações" id="obs" style="height: 200px" name="observacoes">@isset($dados) {{ $dados->observacoes}} @endisset @if($errors->any()){{ old('observacoes') }} @endif </textarea>
